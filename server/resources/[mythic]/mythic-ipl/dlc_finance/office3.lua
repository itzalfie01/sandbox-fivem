		...
		Set = function(style, refresh)
			...
			if IsTable(style) then
				...
				FinanceOffice3.currentSafeDoors =
					{ hashL = GetHashKey(style.safe .. "_l"), hashR = GetHashKey(style.safe .. "_r") }
	...
	Safe = {
		...
		GetDoorHandle = function(doorHash)
			...
			local doorHandle = GetClosestObjectOfType(
				FinanceOffice3.Safe.Position.x,
				FinanceOffice3.Safe.Position.y,
				FinanceOffice3.Safe.Position.z,
				5.0,
				doorHash,
				false,
				false,
			...
			while doorHandle == 0 do
				Wait(25)
				doorHandle = GetClosestObjectOfType(
					FinanceOffice3.Safe.Position.x,
					FinanceOffice3.Safe.Position.y,
					FinanceOffice3.Safe.Position.z,
					5.0,
