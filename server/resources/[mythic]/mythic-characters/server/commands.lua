function RegisterCommands()
	...
	Chat:RegisterStaffCommand("logoutsid", function(source, args, rawCommand)
		...
		if char ~= nil then
			exports["mythic-base"]:FetchComponent("Execute"):Client(char:GetData("Source"), "Characters", "Logout")
		end
	end, {
	...
	Chat:RegisterStaffCommand("logoutsource", function(source, args, rawCommand)
		exports["mythic-base"]:FetchComponent("Execute"):Client(tonumber(args[1]), "Characters", "Logout")
	end, {
	...
	Chat:RegisterAdminCommand("logoutall", function(source, args, rawCommand)
		for k, v in pairs(Fetch:All()) do
			exports["mythic-base"]:FetchComponent("Execute"):Client(v:GetData("Source"), "Characters", "Logout")
		end
	end, {
