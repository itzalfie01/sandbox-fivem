...
-- Dumping database structure for fivem-mythicrp
DROP DATABASE IF EXISTS `fivem-mythicrp`;
CREATE DATABASE IF NOT EXISTS `fivem-mythicrp` /*!40100 DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci */;
USE `fivem-mythicrp`;

-- Dumping structure for table fivem-mythicrp.app_profile_history
...
-- Dumping structure for table fivem-mythicrp.bank_accounts
...
-- Dumping structure for table fivem-mythicrp.bank_accounts_permissions
...
-- Dumping structure for table fivem-mythicrp.bank_accounts_transactions
...
-- Dumping structure for table fivem-mythicrp.bench_schematics
...
-- Dumping structure for table fivem-mythicrp.blueline_race_history
...
-- Dumping structure for table fivem-mythicrp.blueline_tracks
...
-- Dumping structure for table fivem-mythicrp.blueline_track_history
...
-- Dumping structure for table fivem-mythicrp.business_phones
...
-- Dumping structure for table fivem-mythicrp.character_app_profiles
...
-- Dumping structure for table fivem-mythicrp.character_calls
...
-- Dumping structure for table fivem-mythicrp.character_chatter_groups
...
-- Dumping structure for table fivem-mythicrp.character_contacts
...
-- Dumping structure for table fivem-mythicrp.character_documents
...
-- Dumping structure for table fivem-mythicrp.character_documents_shared
...
-- Dumping structure for table fivem-mythicrp.character_emails
...
-- Dumping structure for table fivem-mythicrp.character_messages
...
-- Dumping structure for table fivem-mythicrp.character_parole
...
-- Dumping structure for table fivem-mythicrp.character_photos
...
-- Dumping structure for table fivem-mythicrp.character_schematics
...
-- Dumping structure for table fivem-mythicrp.chatter_groups
...
-- Dumping structure for table fivem-mythicrp.chatter_messages
...
-- Dumping structure for table fivem-mythicrp.crafting_cooldowns
...
-- Dumping structure for table fivem-mythicrp.donator_items
...
-- Dumping structure for table fivem-mythicrp.donor_created_item
...
-- Dumping structure for table fivem-mythicrp.firearms
...
-- Dumping structure for table fivem-mythicrp.firearms_flags
...
-- Dumping structure for table fivem-mythicrp.inventory
